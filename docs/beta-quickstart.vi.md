...
Hướng dẫn này cài CLI `v0.1.0-beta.3` từ GitHub Release tarball, sau đó cài
...
Version phải là `0.1.0-beta.3`. Nếu không tìm thấy `specrelay`, hãy mở terminal
...
- **Không thấy plugin:** chạy `codex plugin marketplace list`, kiểm tra ref
  `v0.1.0-beta.3`, restart desktop app rồi cài trong Plugins directory.
