...
`v0.1.0-beta.3` may be released only after the designated maintainer reads this
...
- [ ] Confirm the release tag, package version, manifest version, and marketplace ref are all `v0.1.0-beta.3` / `0.1.0-beta.3`.
